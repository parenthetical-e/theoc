...
exp1:
	...
	parallel -j 4 -v \
			...
			--nice 19 --colsep ',' \
			'python theoc/exp/run_exp.py data/exp1/stim_rate-_{1}_g-{2}1_num_pop-{4}_q-{3} --num_trials=20 --num_background=5 --t=5 --osc_rate=2 --f=6 --g={2} --g_max=8 --q={3} --stim_rate={1} --frac_std=0.01 --m=8 --priv_std=0 --num_pop={4} --stim_seed={5}' ::: 2 6 10 14 18 22 26 30 ::: 1 2 3 4 5 7 8 ::: 0.0 0.5 1.0 ::: 10 25 50 75 100 500 ::: {1..20}
