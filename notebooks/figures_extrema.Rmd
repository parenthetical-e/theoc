...
tmp %>% 
  ...
  labs(y=expression(paste(Delta, "MI")), x="Model", title="Average case") +
  theme_classic() + 
...
tmp %>% 
  ...
  stat_summary(aes(group=model), fun.y=min, 
               geom="point", colour="black", alpha=1, size=10, shape="_") +
  geom_hline(yintercept=0, color="dark grey", size=0.5) + xlab("") +
  labs(y=expression(paste(Delta, "MI")), x="Model", title="Worst case") +
  theme_classic() + 
  theme(plot.title = element_text(size = 10, face = "bold")) -> 
  p3
...
tmp %>% 
  ...
  stat_summary(aes(group=model), fun.y=max, 
               geom="point", colour="black", alpha=1, size=10, shape="_") +
  geom_hline(yintercept=0, color="dark grey", size=0.5) + xlab("") +
  labs(y=expression(paste(Delta, "MI")), x="Model", title="Best case") +
  theme_classic() + 
  theme(plot.title = element_text(size = 10, face = "bold")) -> 
  p5
...
ggsave("figures/extrema1.pdf", dpi=600)
