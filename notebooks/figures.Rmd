...
tmp %>% 
  ...
  geom_jitter(size=.02, alpha=0.01) +
...
tmp %>% 
  ...
  geom_jitter(data=p_tmp, aes(x=num_pop, y=mi), size=.02, alpha=0.01, width=.05, color="black") +
...
```{r, fig.width=4.2, fig.height=2.3, echo=FALSE, warning=FALSE, message=FALSE}
# --------------------------------------------------------------
## Models overall
dmi_exp21 %>% 
  filter(q == "0.5") %>% 
...
tmp %>% 
  ggplot(aes(x=model, y=mi)) +
  geom_jitter(size=.01, alpha=0.05, color="black") +
  stat_summary(aes(group=model), fun.y=mean, 
               geom="point", colour="black", alpha=1, size=10, shape="_") +
  geom_hline(yintercept=0, color="dark grey") + xlab("") +
...
tmp %>% 
  ...
  geom_hline(yintercept=0, color="dark grey") + xlab("") +
  geom_jitter(data=p_tmp, aes(x=stim_rate, y=mi), size=.01, alpha=0.01, width=.6, color="black") +
...
tmp %>% 
  ggplot(aes(x=model, y=mi)) +
  geom_jitter(size=.02, alpha=0.1, color="darkgrey") +
  stat_summary(aes(group=model), fun.y=mean, 
               geom="point", colour="black", alpha=1, size=10, shape="_") +
  geom_hline(yintercept=0, color="dark grey", size=0.5) + xlab("") +
...
tmp %>% 
  ...
  geom_hline(yintercept=0, color="dark grey") + xlab("") +
  geom_jitter(data=p_tmp, aes(x=osc_rate, y=mi), size=.01, alpha=0.005, width=.25, color="black") +
  geom_line(size=0.6, alpha=1) +
...
tmp %>% 
  ggplot(aes(x=model, y=mi)) +
  # lims(y=c(-.3, 0.5)) +
  geom_jitter(size=0.04, alpha=0.02) +
  stat_summary(aes(group=model), fun.y=mean, 
               geom="point", colour="black", alpha=1, size=10, shape="_") +
  geom_hline(yintercept=0, color="dark grey") + xlab("") +
  labs(y=expression(paste(Delta, "MI")), x="") +
...
tmp %>% 
  ...
  geom_line(size=0.5, alpha=1) +
  geom_hline(yintercept=0, color="dark grey") + xlab("") +
  geom_jitter(data=p_tmp, aes(x=stim_rate, y=mi), size=0.04, alpha=0.02, width=.25, color="black") +
  labs(y=expression(paste(Delta, "MI")), x="Stimulus firing rate") +
  scale_color_manual("g", values = c(
    "lightsteelblue3",
    "lightskyblue3",
...
tmp %>% 
  ...
  geom_line(size=0.5, alpha=1) +
  geom_hline(yintercept=0, color="dark grey") + xlab("") +
  geom_jitter(data=p_tmp, aes(x=osc_rate, y=mi), size=0.04, alpha=0.02, width=.25, color="black") +
  labs(y=expression(paste(Delta, "MI")), x="Pacemaker firing rate") +
  scale_color_manual("g", values = c(
    "lightsteelblue3",
    "lightskyblue3",
...
tmp %>% 
  ggplot(aes(x=f, y=mi)) +
  geom_jitter(width=1.5, size=0.04, alpha=0.02) +
...
tmp %>% 
  ...
  geom_jitter(width=1, size=0.04, alpha=0.02) +
  geom_hline(yintercept=0, color="grey") + xlab("") +
...
tmp %>% 
  ggplot(aes(x=m, y=mi)) +
  geom_jitter(width=0.2, size=0.04, alpha=0.02) +
  geom_hline(yintercept=0, color="grey") + xlab("") +
