...
tmp %>% 
  ...
  labs(y=expression(paste(Delta, "MI")), x="Power", title="Population size: 40") +
  theme_classic() + 
  geom_hline(yintercept=0, color="dark grey", size=0.5) +
  theme(legend.background = element_rect(colour ="black")) +
  theme(strip.background = element_blank()) +
...
tmp %>% 
  ...
  geom_point(size=.02, alpha=0.05) +
  stat_smooth(method="lm", se = TRUE, alpha=1, size=0.6, color="black") +
  labs(y=expression(paste(Delta, "MI")), x="Power", title="Population size: 10240") +
  theme_classic() + 
  lims(y=c(-0.5, 0.5)) +
  scale_x_continuous(breaks=c(0, 0.5, 1), limits=c(0, 1.25)) +
  geom_hline(yintercept=0, color="dark grey", size=0.5) +
...
p1 / p2 + 
  plot_annotation(tag_levels = 'a', tag_suffix = ".")
ggsave("figures/power1.pdf", dpi=600)
```
...
tmp %>% 
  ...
  geom_hline(yintercept=0, color="dark grey", size=0.5) + 
  labs(y=expression(paste(Delta, "MI")), x="Power", title="E") +
  scale_color_manual("g", values = c(
    "lightsteelblue3",
    "lightskyblue3",
    "steelblue3",
...
tmp %>% 
  ...
  stat_smooth(method="lm", se = FALSE, alpha=1) +
  geom_hline(yintercept=0, color="dark grey", size=0.5) + 
  labs(y=expression(paste(Delta, "MI")), x="Power", title="EI") +
  scale_color_manual("g", values = c(
    "lightsteelblue3",
    "lightskyblue3",
    "steelblue3",
...
tmp %>% 
  ...
  stat_smooth(method="lm", se = FALSE, alpha=1) +
  geom_hline(yintercept=0, color="dark grey", size=0.5) + 
  labs(y=expression(paste(Delta, "MI")), x="Power", title="I") +
  scale_color_manual("g", values = c(
    "lightsteelblue3",
    "lightskyblue3",
    "steelblue3",
...
tmp %>% 
  ...
  stat_smooth(method="lm", se = FALSE, alpha=1) +
  geom_hline(yintercept=0, color="dark grey", size=0.5) + 
  labs(y=expression(paste(Delta, "MI")), x="Power", title="II") +
  scale_x_continuous(breaks=c(0, 0.5, 1), limits=c(0, 1.25)) +
  scale_color_manual("g", values = c(
    "lightsteelblue3",
    "lightskyblue3",
...
ggsave("figures/power2.pdf", dpi=600)
```

# Supp. Figure - Constant modulation
